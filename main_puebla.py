...
from bot_puebla import crear_bot_puebla
import hashlib
import secrets
import hmac
import base64
...
# ==================== BOT PUEBLA MODULAR ====================
bot, dp, bot_runtime = crear_bot_puebla(
    bot_token=BOT_TOKEN,
    supabase=supabase,
    precio=PRECIO,
    entidad=ENTIDAD,
    timezone=TZ,
    generar_folio_async=generar_folio_async,
    generar_pdf=generar_pdf,
)

# Alias de compatibilidad para el dashboard existente
timers_activos = bot_runtime.timers_activos
